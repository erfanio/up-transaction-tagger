...
class DisplayErrors extends Component<DisplayErrorsProps, DisplayErrorsState> {
  ...
  render() {
    ...
    if (caughtError) {
      if (
        caughtError instanceof FetchError &&
        caughtError.errorDetails.status == '401'
      ) {
        return (
      ...
      return (
        <div className="card text error">
          ...
          <p>
            Maybe to take screenshot of this error and create an issue on
            Github,{' '}
            <a
              href="https://github.com/erfanio/up-transaction-tagger/issues"
              target="_blank"
            >
          ...
          {!apiKey ? (
            <div className="card text">
              ...
              <p>
                ...
                transaction data and add some features that @erfanio wanted to
                have :)
              </p>
              <h2>How Does It Work?</h2>
              <p>
                Up Bank offers an Application Programming Interface (API) which
                is a convenient way to allow third-party apps to <b>only</b>
                access your transaction data and do minor changes like adding
                tags and categories.
              </p>
              <p>
